"""Physical health calendar heatmap (GitHub-style, using calplot)."""
...
DEFAULT_INPUT = "out/llama/physical_health_*_normalized.json"
...
def main():
    ...
    sickness_map = data["physical_sickness_map"]

    # Count conditions per day
    day_counts = defaultdict(int)
    for condition, entries in sickness_map.items():
    ...
    fig, ax = calplot.calplot(
        ...
        cmap="BuPu",
        colorbar=True,
        suptitle="Physical health through the year",
    ...
    save_figure(fig, "physical_health_calendar")
